...
class U2fPostRegistrationEventTest extends TestCase
{
    private $event;
    private $user;
    private $key;
    ...
    {
        $name = 'u2f.registration.after';

        $this->assertEquals(U2fPostRegistrationEvent::getName(), $name);
    ...
    private function setUpFailure()
    {
        ...
        $this->event = new U2fPostRegistrationEvent($this->user);
    }
    ...
    private function setUpSuccess()
    {
        ...
        $this->event = new U2fPostRegistrationEvent($this->user, $this->key);
    }
}
